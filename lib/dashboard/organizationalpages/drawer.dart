...
import 'package:minorproject/dashboard/organizationalpages/faq.dart';
...
import 'package:minorproject/dashboard/organizationalpages/setting.dart';
      ...
      child: ListView(
        ...
        children: [
          UserAccountsDrawerHeader(
            accountName: const Text("Organization",
                style: TextStyle(
                  color: Colors.black,
            ...
            currentAccountPicture: CircleAvatar(
              child: ClipOval(
                child: Image.asset("assets/images/organizationprofile.png"),
              ),
            ),
            // ignore: prefer_const_constructors
            decoration: BoxDecoration(
                color: const Color.fromARGB(255, 66, 108, 110),
                // ignore: prefer_const_constructors
